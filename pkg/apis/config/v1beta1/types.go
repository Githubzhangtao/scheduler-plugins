...
// BalanceNetSchedulingArgs defines the scheduling parameters for BalanceNetScheduling plugin.
type BalanceNetSchedulingArgs struct {
	metav1.TypeMeta     `json:",inline"`

	ResourceToWeightMap []schedulerconfig.ResourceSpec `json:"resourceToWeightMap,omitempty"`
	// KubeMaster is the url of api-server
	KubeMaster *string `json:"kubeMaster,omitempty"`
	// KubeConfigPath for scheduler
	KubeConfigPath *string `json:"kubeConfigPath,omitempty"`
